...
const DeleteTeacher = () => {
    // State to hold the teacher's email input value
    ...
    // Function to handle the click event for deleting a teacher
    async function handleClick(){
        ...
        try{
            // Send DELETE request to the server to delete the teacher
            ...
            console.log('Error occurred while deleting teacher : ', err);
