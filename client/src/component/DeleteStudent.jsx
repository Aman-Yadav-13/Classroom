...
const DeleteStudent = () => {
    // State to hold the student email input value
    ...
    // Function to handle the click event for deleting a student
    async function handleClick(){
        ...
        try{
            ...
            const response = await axios.delete('https://classroom-ozmt.onrender.com/api/delete-student', { data : { id : email } });
        ...
        <div className="flex justify-center items-center h-screen">
            <div className="artboard h-[30%] w-[20%] bg-base-300 flex items-center flex-wrap justify-center m-[5%] rounded-lg">
                ...
                <div>
                    ...
                    <button className="btn hover:bg-primary text-white" onClick={handleClick}>Delete Student</button>
                </div>
            </div>
        </div>}
        </>
